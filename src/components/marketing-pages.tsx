...
const specs: Record<string, PageSpec> = {
  ...
  integrations: {
    ...
    blocks: [
      { icon: Mail, title: "Microsoft 365 and Gmail", copy: "Forward selected vendor messages to your private workspace address, or authorize a scoped mailbox connection when it is enabled for your workspace. You control the vendors Costivra may monitor and can revoke access." },
