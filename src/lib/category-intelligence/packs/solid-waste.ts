...
export const solidWastePack: CategoryExpertPackV1 = {
  ...
  lineItems: [
    ...
    },
    {
      ...
      meaning:
        "Carrier-imposed fee (not a direct government tax) to recover environmental compliance costs. Typically 8–18% of base service. Unlike franchise fees, this is largely discretionary margin — it is negotiable in non-franchise markets and should be reviewed at contract renewal.",
      chargeClass: "surcharge",
      units: ["percentage_of_base_service"],
      expectedContext: ["all_waste_services"],
      benchmarkable: true,
  ...
  evalCaseIds: ["eval-waste-001", "eval-waste-002"],
};
