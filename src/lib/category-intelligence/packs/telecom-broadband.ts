...
export const telecomBroadbandPack: CategoryExpertPackV1 = {
  ...
  lineItems: [
    ...
    },
    {
      ...
      meaning:
        "Pass-through regulatory surcharge mandated by the FCC to fund rural broadband, schools, and libraries. Rate changes quarterly. Not negotiable.",
  ...
  evalCaseIds: ["eval-tele-001", "eval-tele-002"],
};
