...
describe("Client Assistant V2 Integration Suite", () => {
  ...
  it("assembles system prompt with Costivra financial doctrine and bounded context", () => {
    const mockContext: AssistantBoundedContext = {
      ...
      attachedDocuments: [{ id: "doc-1", filename: "att-july.pdf", status: "processed", extractionSummary: "July bill", category: "Telecom" }],
      recentVendors: [{ id: "v-1", name: "AT&T", category: "Telecom", spend: 12000 }],
      recentInvoices: [{ id: "i-1", vendorName: "AT&T", category: "Telecom", amount: 1000, date: "2026-07-31", status: "ready", documentId: "doc-1" }],
      recentExpenses: [],
      verifiedSavings: [],
      pendingApprovals: [],
      supplierCatalog: [],
