...
export function buildEmailSignatureHtml(profile: EmailSignatureProfile) {
  ...
  return `<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:620px;margin-top:24px;font-family:Arial,Helvetica,sans-serif;color:#1d2b3a;border-collapse:collapse;"><tr><td style="padding:0 0 16px;border-top:1px solid #d9e2ec;font-size:1px;line-height:1px;">&nbsp;</td></tr><tr><td><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr><td style="width:3px;background:#002fa7;border-radius:3px;"></td><td style="padding:0 0 0 13px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr><td style="padding:0 0 11px 0;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="border:1px solid #e1e6ed;border-radius:9px;border-collapse:separate;background:#ffffff;color:#111927;color-scheme:light;"><tr><td style="padding:5px 9px 5px 6px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr><td style="padding:0 9px 0 0;"><img src="${COSTIVRA_EMAIL_LOGO_URL}" width="34" height="31" alt="Costivra" style="display:block;width:34px;height:31px;object-fit:contain;border:0;outline:none;text-decoration:none;" /></td><td style="vertical-align:middle;"><strong style="display:block;color:#111927!important;font-size:15px;line-height:17px;letter-spacing:-.2px;">Costivra</strong></td></tr></table></td></tr></table></td></tr><tr><td><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr><td style="padding:1px 11px 0 0;vertical-align:top;">${avatar}</td><td style="vertical-align:middle;"><div style="font-size:18px;font-weight:700;line-height:22px;color:#172942;">${name}</div>${title ? `<div style="padding-top:1px;color:#1f5cba;font-size:13px;font-weight:700;font-style:italic;line-height:18px;">${title}</div>` : ""}</td></tr></table></td></tr><tr><td style="padding:8px 0 0;color:#526075;font-size:12px;line-height:18px;">${details}</td></tr><tr><td style="padding:5px 0 0;color:#667085;font-size:11px;line-height:16px;">Every recurring cost, under command.</td></tr></table></td></tr></table></td></tr><tr><td style="padding:14px 0 0;border-top:1px solid #d9e2ec;color:#6b7480;font-size:8.5px;line-height:12px;"><strong style="color:#172942;">CONFIDENTIALITY DISCLAIMER:</strong> This email and any attachments may contain confidential information intended only for the named recipient. Please handle it in accordance with applicable privacy and electronic-communications laws, including the Electronic Communications Privacy Act (ECPA), 18 U.S.C. §§ 2510–2521. Unauthorized review, use, disclosure, or distribution is prohibited. If you received it in error, please notify the sender and delete all copies.</td></tr></table>`;
}
