...
- Updated `09_STRIPE_SUBSCRIPTIONS_AND_ENTITLEMENTS.md` and `10_PAID_ONBOARDING_AND_ACTIVATION.md` to reflect the current dynamic pricing catalog, existing billing/onboarding implementation, remaining paid self-service gaps, `/app/settings` customer route, and required proof gates. Documentation-only validation: `git diff --check` passed.
