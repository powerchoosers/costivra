...
- Focused adapter and route coverage passed (13 tests), TypeScript passed, and browser QA passed at desktop and 390×844 mobile with no horizontal overflow or console errors. The mobile test used a temporary viewport override and restored the browser afterward.
