-- The prior lifecycle migrations are already deployed. Re-declare only the
-- hardened destructive contracts here so migration history remains immutable.
