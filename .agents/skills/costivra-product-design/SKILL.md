...
- Keep container styles quiet: white or subtly translucent surfaces, 1px neutral borders, restrained shadows, consistent 16–22px radii, generous whitespace, and status dots/chips rather than heavy colored rails or tinted dashboard cards.
